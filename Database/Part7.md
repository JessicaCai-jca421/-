...
![1658187450138](image/Part7/1658187450138.png)

现在计算成对表的估计结果，由于没有中间表，因此成本仍然为0

![1658187616445](image/Part7/1658187616445.png)

请注意，不同顺序的相同表的连接结果大小相同

size= T（RxSxT）=1000 *1000 *1000/200 /500=10000
